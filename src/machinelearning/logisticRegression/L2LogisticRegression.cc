...
L2LogisticRegression<Feature>::L2LogisticRegression(vector<Feature>& trainFeatures, Vector& y, int m, int n, int nClasses,
                                                    double lambda, int algtype, int maxIter, double eps, int miniBatch, int lbfgsMemory) : Classifiers<Feature>(m, n), nClasses(nClasses),
...
// save the model
template <class Feature>
int L2LogisticRegression<Feature>::saveModel(char* model){
...
template <class Feature>
int L2LogisticRegression<Feature>::loadModel(char* model){
